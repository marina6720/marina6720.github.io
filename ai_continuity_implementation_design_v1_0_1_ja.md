...
**Version 1.0.1 — 2026年8月22日**  
**Status：Public candidate — v1.0 verification complete; v1.0.1 final artifact check pending**
...
本v1.0.1は、その検証済みv1.0に対して、2026年8月22日までに提示された軽修正を反映した**public candidate**である。

公開確定前の最終チェックとして、

1. VecTA / Faroによるv1.0.1現物との再照合
2. GitHub Pages上でのMathJax実レンダリング確認
3. Appendix Dの内部リンク確認
4. version / hash / 公開ファイルの一致確認
